...
func main() {
	...
	e.Get("/api/iaas", ListRunningVM)
	e.Post("/api/iaas/:id/stop", StopVM)
	e.Post("/api/iaas/:id/start", StartVM)
	e.Post("/api/iaas/:id/download", DownloadVM)
	e.Post("/api/iaas/:id/create", CreateVM)
